    ...
    >
      <div className="relative w-full">
        ...
        <div className="mr-10 flex justify-end gap-2">
          ...
          >
            <IconArrowNarrowLeft className="h-6 w-6 text-[#295C55]" />
          </button>
          <button
            className="relative z-40 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 disabled:opacity-50"
            onClick={scrollRight}
          ...
          >
            <IconArrowNarrowRight className="h-6 w-6 text-[#295C55]" />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
  ...
  return (
    <>
          ...
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            >
              <button
                ...
                onClick={handleClose}
              >
                <IconX className="h-6 w-6 text-[#295C55]" />
              </button>
              <motion.p
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-80 w-56 flex-col items-start justify-start overflow-hidden rounded-3xl bg-neutral-900 md:h-[35rem] md:w-96"
      >
