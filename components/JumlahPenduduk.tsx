  ...
  const data = [
    {
      ...
      label: 'Penduduk',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 15 16" fill="currentColor">
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path strokeLinecap="round" strokeLinejoin="round" d="M10 16v5m4-5v5M9 9h6l-1 7h-4zm-4 2c1.333-1.333 2.667-2 4-2m10 2c-1.333-1.333-2.667-2-4-2m-5-5a2 2 0 1 0 4 0a2 2 0 1 0-4 0"/>
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
          <path
            ...
            strokeWidth="2"
            d="M10 16v5m4-5v5m-6-5h8l-2-7h-4zm-3-5c1.667-1.333 3.333-2 5-2m9 2c-1.667-1.333-3.333-2-5-2m-4-5a2 2 0 1 0 4 0a2 2 0 1 0-4 0"
          />
        </svg>
      ),
    },
    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6">
        {data.map((item, idx) => (
          <div
            key={idx}
            className="flex justify-between items-center bg-gradient-to-r from-[#295C55] to-[#143d47] text-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300"
          >
            <div>
